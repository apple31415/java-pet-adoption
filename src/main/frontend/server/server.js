...
app.get('/api/v1/pets/:pet_type', (req, res) => {
  let queryString = "SELECT  adoptable_pets.id,adoptable_pets.type_id, * FROM adoptable_pets JOIN pet_types ON adoptable_pets.type_id = pet_types.id WHERE pet_types.type = $1"
